...
//        İşleme başlarken bir önceki değer olmadığı için bu değer identity parametresinde tanımlanmaktadır.
    ...
    public static void alfabetikBuyukHarfTekrarsiz(List<String> yemek) {
        ...
        yemek.stream().distinct().map(String::toUpperCase).forEach(Utils::ayniSatirdaBosluklaYazdir);
    ...
    public static void karakterSayiYedidenBuyuk(List<String> yemek) {
       ...
       //modern yazim Java8 cozumu
        System.out.println(yemek.stream().
                allMatch(t->t.length()<=7) ?
                "List elemanlari 7 ve daha az harften olusmus" : "bazi elemanlar 7 den buyuk");
    }
    ...
    public static void basHarfiWIleBaslayan(List<String> yemek) {
        ...
        System.out.println(yemek.stream().anyMatch(t->t.startsWith("W")));
...
*/
    ...
    public static void sonHarfeGoreSiralaIlkHaricElmanlariYaz(List<String> yemek) {
        ...
        Stream<String> ilkelemanharic=yemek.stream().sorted(Comparator.comparing(t -> t.toString().length() - 1).
                reversed()).skip(2);
        System.out.println(Arrays.toString(ilkelemanharic.toArray()));
