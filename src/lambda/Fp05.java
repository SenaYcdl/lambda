...
public class Fp05 {
    public static void main(String[] args) {
        ...
        //new keywordunden sona constructor kullanilir
        //Courses classda olusturulan objelerin listesi olusturuldu
        ...
        System.out.println("ortalamaPuanlarVerilenSayidanBuyukMu= " +
                ortalamaPuanlarVerilenSayidanBuyukMu(coursesList,95));
        System.out.println("kelimeKursAdlariIcindeVarMi= " +
                kelimeKursAdlariIcindeVarMi(coursesList,"Turkish"));
        ortalamaPuaniEnYuksekKurs(coursesList);
        System.out.println("ortalamaPuanaGoreSiralaVeilkVerilenleriAtla = " +
                ortalamaPuanaGoreSiralaVeilkVerilenleriAtla(coursesList, 1));
    ...
    public static void ortalamaPuaniEnYuksekKurs (List<Courses> list) {
        ...
        System.out.println("En yuksek ortalama puana sahip kurs:" + sonuc);
    }
